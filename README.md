...
Dupliquez `projects/01-sphere`, renommez le dossier (`xx-mon-projet`), changez le champ `name` de son `package.json` avec le même nom, puis relancez `npm install` à la racine.
